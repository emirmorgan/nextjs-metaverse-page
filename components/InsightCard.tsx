...
const InsightCard = ({ imgUrl, title, subtitle, index }: CardProps) => {
  return (
    <motion.div
      ...
      className="relative flex md:flex-row flex-col gap-4"
    >
      <div className="flex md:min-w-[270px] h-[250px] relative">
        <Image
          src={imgUrl}
          alt={title}
      ...
      <div className="w-full flex justify-between items-center">
        ...
        <div className="lg:flex hidden items-center justify-center w-[100px] h-[100px] rounded-full bg-transparent border-[1px] border-white cursor-pointer hover:rotate-[80deg] hover:scale-105 transition-all ease-linear duration-200">
          <svg
            width="30"
            height="25"
            viewBox="0 0 30 25"
